            ...
            <div className='bg-slate-100 p-4 rounded-md flex items-center justify-between mb-4'>
              <div>
                <span className='font-medium'>
                  {selectedRowCount} bài đăng được chọn
                </span>
              </div>
            ...
            <div className='rounded-md border'>
              ...
              <div className='flex items-center justify-between px-4 py-3 border-t w-full'>
                <div className='text-xs text-gray-500'>
                  Hiển thị {allPost?.data?.data?.length ? '1' : '0'} đến {allPost?.data?.data?.length || 0} trong tổng số {allPost?.data?.totalDocs || 0} bài đăng hệ thống
                </div>
                <Pagination
