...
export function Comment({ comment, replies, commentMap }: CommentProps) {
  ...
  const handleAddReply = () => {
    ...
    // Here you would typically call an API to add a reply
          ...
          {showReplyForm && (
            <div className="mt-3 ml-1">
              ...
              <div className="mt-2 flex justify-end gap-2">
                ...
                <Button className="bg-[#E03C31]" size="sm" onClick={handleAddReply}>
                  Bình luận
                </Button>
              </div>
            </div>
