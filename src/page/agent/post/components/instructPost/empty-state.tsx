  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen'>
      <motion.div
        ...
        className='text-center max-w-sm border border-red-200 rounded-lg py-6 px-10 bg-white shadow-sm'
      >
        <div className='w-16 h-16 mx-auto mb-4 bg-red-100 rounded-full flex items-center justify-center'>
          <AlertCircle className='w-8 h-8 text-red-500' />
        </div>

        <h2 className='text-[18px] font-medium mb-2 text-red-600'>Chưa có bất động sản</h2>
      ...
      <div className='mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-[600px] '>
        {[
          ...
          >
            <div className='flex items-start'>
              <div className='flex-1'>
                <h3 className='text-[14px] font-medium text-red-500'>{item.title}</h3>
      ...
      <motion.div
        ...
        className='mt-6 text-[10px] text-gray-400 text-[14px] '
      >
        Bạn cần trợ giúp?{' '}
        <Link to='/ho-tro' className='text-red-400 hover:underline text-[14px] '>
          Liên hệ hỗ trợ
        </Link>
      </motion.div>
    </div>
