...
export function DraftPostEditForm({ post, onSave }: DraftPostEditFormProps) {
  ...
  const directions: Direction[] = ['Bắc', 'Nam', 'Đông', 'Tây', 'Đông Bắc', 'Đông Nam', 'Tây Bắc', 'Tây Nam'];

  const statuses: PostDraftStatus[] = ['draft', 'pending', 'published', 'rejected', 'expired'];
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Nhập giá bằng VND, không cần nhập dấu phẩy</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder='Mô tả chi tiết về bất động sản' className='min-h-32' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                render={({ field }) => (
                  <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4'>
                    ...
                    <div className='space-y-1 leading-none'>
                      ...
                      <FormDescription>Bất động sản đã được trang bị nội thất</FormDescription>
                    </div>
                  </FormItem>
                )}
              />
            ...
            <Card>
              <CardContent className='p-6'>
                <div className='flex flex-col items-center justify-center py-10 border-2 border-dashed rounded-lg'>
                  ...
                  <p className='text-sm text-muted-foreground mb-2'>Kéo và thả hình ảnh vào đây hoặc nhấp để tải lên</p>
                  <Button variant='outline' className='mt-2'>
                    Chọn hình ảnh
                  </Button>
                </div>
                <Alert className='mt-4'>
                  <AlertDescription>Tính năng tải lên hình ảnh chưa được triển khai trong demo này.</AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          </TabsContent>
