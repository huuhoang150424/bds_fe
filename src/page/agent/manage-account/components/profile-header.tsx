              ...
              <div className='flex items-center gap-3 mt-1'>
                ...
                <motion.div
                  ...
                  className={cn(
                    ...
                    'dark:from-amber-900/50 dark:to-amber-800/50 dark:text-amber-200',
                    'hover:shadow-md hover:shadow-amber-300/50 dark:hover:shadow-amber-900/50',
                  )}
                >
                  <Sparkles className='h-3 w-3' />
                  {user.isProfessional ? 'Chuyên nghiệp' : 'Bình thường'}
                </motion.div>
              </div>
            </div>
