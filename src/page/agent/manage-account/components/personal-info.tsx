      ...
      <CardContent className='pt-4 grid gap-6'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div className='space-y-1.5 p-3 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800'>
            ...
            <div className='font-medium text-sm text-gray-900 dark:text-gray-100'>{user.fullname}</div>
          </div>
          ...
          <div className='space-y-1.5 p-3 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800'>
            ...
            <div className='font-medium text-sm text-gray-900 dark:text-gray-100'>{user.gender}</div>
          </div>
          ...
          <div className='space-y-1.5 p-3 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800'>
            ...
            <div className='font-medium text-sm text-gray-900 dark:text-gray-100'>{user.phone}</div>
          </div>
          ...
          <div className='space-y-1.5 p-3 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800'>
            ...
            <div className='font-medium text-sm text-gray-900 dark:text-gray-100'>
              {format(user.dateOfBirth, 'dd/MM/yyyy', { locale: vi })}
            </div>
          </div>
          ...
          <div className='space-y-1.5 p-3 rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800'>
            ...
            <div className='font-medium text-sm text-gray-900 dark:text-gray-100'>{user.address}</div>
          </div>
        </div>
