        ...
        <div className="container mx-auto grid grid-cols-12 gap-6 text-gray-800">
          ...
          <div className="col-span-4">
            ...
            <p className="text-sm mt-1">
              Giấy phép đăng ký kinh doanh số 0315459774 do Sở Kế hoạch đầu tư TP
              Hồ Chí Minh cấp 04/01/2019.
            </p>
            <p className="text-sm mt-1">
              📍 Số M2 Đường 38, Phường 6, Quận 4, TP Hồ Chí Minh.
            </p>
          ...
          <div className="col-span-2">
            ...
            <ul className="text-sm mt-2 space-y-1">
              ...
              <li><a href="#">Chi phí đăng tin</a></li>
          ...
          <div className="col-span-4">
            ...
            <p className="text-sm mt-2">
              Chịu trách nhiệm & đại diện pháp luật: Dương Ngọc Báu. Vui lòng ghi
              rõ nguồn batdongsanonline.vn khi sử dụng dữ liệu của chúng tôi.
            </p>
            <p className="text-sm mt-2">
              Doanh nghiệp có nhu cầu đăng tin số lượng lớn, vui lòng liên hệ
              Hotline.
            </p>
